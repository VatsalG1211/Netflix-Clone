                ...
                <tbody>
                    <tr>
                        <td align="left" class="m_6356931864151141868content-padding"
                            ...
                            Help us verify your email address</td>
                    </tr>
                </tbody>
            </table>
            <table align="left" width="100%" cellpadding="0" cellspacing="0">
            ...
            <table align="left" width="100%" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td align="left" class="m_6356931864151141868content-padding"
                            style="padding-left:40px;padding-right:40px;font-family:NetflixSans-Regular,Helvetica,Roboto,Segoe UI,sans-serif;font-weight:400;font-size:16px;line-height:21px;padding-top:20px;color:#221f1f">
                            Verify your email address to help keep your account more secure and up-to-date.</td>
                    </tr>
                </tbody>
            </table>
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <a href="{full_link}"
                                                ...
                                                target="_blank"
                                                data-saferedirecturl="#">Verify email
                                                </a></td>
                                    </tr>
                                </tbody>
                            </table>
