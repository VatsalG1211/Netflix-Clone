...
ALLOWED_HOSTS = ['192.168.1.9','192.168.1.15','192.168.104.19','192.168.40.19', 'localhost', '127.0.0.1']
...
EMAIL_HOST_PASSWORD = 'bdoy zjdb aowf kgxk'
EMAIL_USE_TLS = True

LOGIN_URL = "login"

RAZORPAY_KEY_ID = "rzp_test_7xXcnbF7Tlk7eW"

RAZORPAY_SECRET_KEY = "X2EQudF7N60r1gOByNyP0faF"